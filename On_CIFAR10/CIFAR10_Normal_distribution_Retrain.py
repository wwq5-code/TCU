...
if args.dataset == 'MNIST':
    ...
    test_set = CIFAR10('../data/cifar', train=False, transform=base_transform, download=True)
    multi_view_dataset = MultiViewCIFAR(train_set, args.k, base_transform, aug_transform)
    original_train_set = CIFAR10('../data/cifar', train=True, transform=base_transform, download=True)
