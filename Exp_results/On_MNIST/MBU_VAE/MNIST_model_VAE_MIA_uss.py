...
OUL = [0.5950, 0.5850, 0.6160, 0.6449, 0.6553 ]

org_acc = [0.4939, 0.4939, 0.4939, 0.4939, 0.4939]
...
plt.savefig('MNIST_model_VAE_MIA_uss.pdf', format='pdf', dpi=200)
plt.show()