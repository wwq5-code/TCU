...
MBU = [0.5899, 0.6099, 0.6299, 0.6499, 0.6599, 0.6899]

org_acc = [0.5299, 0.5299,  0.5299, 0.5299, 0.5299, 0.5299]

# GA = [0.6299, 0.6299,  0.6299, 0.6299, 0.6299, 0.6299]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]

VBU = [0.58, 0.58, 0.58, 0.58, 0.58, 0.58]
...
plt.savefig('MNIST_model_MIA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()