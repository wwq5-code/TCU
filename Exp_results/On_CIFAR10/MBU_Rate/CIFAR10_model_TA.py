...
OUL = [0.8225, 0.8216, 0.8180, 0.8089, 0.8046, 0.8010]

org_acc = [0.8299, 0.8299, 0.8299, 0.8299, 0.8299, 0.8299]
...
my_y_ticks = np.arange(79., 83.4, 0.6)
...
plt.savefig('CIFAR10_model_TA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()