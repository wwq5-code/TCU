...
OUL = [0.6399, 0.6499, 0.6599, 0.6699, 0.68999, 0.74]

org_acc = [0.53, 0.53, 0.53, 0.53, 0.53, 0.53]
...
plt.legend(loc=(0.53, 0.22),fontsize=20)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('CIFAR10_model_MIA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()