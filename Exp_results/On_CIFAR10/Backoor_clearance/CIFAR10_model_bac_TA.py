...
OUL = [0.7956, 0.8007, 0.7992, 0.8012, 0.7929, 0.7829]

org_acc = [0.8179, 0.8179, 0.8179, 0.8179, 0.8179, 0.8179]

vbu_acc = [0.9442, 0.9445,  0.9401, 0.9411, 0.9472, 0.9467]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.8066, 0.8066, 0.8066, 0.8066, 0.8066, 0.8066]
...
my_y_ticks = np.arange(78., 82.4, 0.6)
...
plt.savefig('CIFAR10_model_bac_TA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()