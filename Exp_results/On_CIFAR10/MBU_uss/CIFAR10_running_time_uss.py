...
ax1.plot(x, OUL, linestyle='-', color='#797BB7', marker='o', fillstyle='full', markevery=markevery, label='MBU', linewidth=l_w, markersize=m_s, markeredgewidth=marker_s)
...
plt.savefig('CIFAR10_running_time_uss.pdf', format='pdf', dpi=200)
plt.show()