...
ax2.plot(x, OUL, linestyle='-', color='#797BB7', marker='o', fillstyle='full', markevery=markevery, label='TCU', linewidth=l_w, markersize=m_s, markeredgewidth=marker_s)
...
# Labels
ax2.set_xlabel('$\it USS$' ,fontsize=20)
...
plt.savefig('tiny_imagenet_running_time_uss.pdf', format='pdf', dpi=200)
plt.show()