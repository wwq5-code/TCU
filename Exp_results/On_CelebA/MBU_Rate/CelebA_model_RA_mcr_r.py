...
OUL = [0.9686, 0.9682, 0.9681, 0.9680, 0.9679, 0.9677]

org_acc = [0.9695, 0.9695, 0.9695, 0.9695, 0.9695, 0.9695]

vbu_acc = [0.9442, 0.9445,  0.9401, 0.9411, 0.9472, 0.9467]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.9668, 0.9668, 0.9668, 0.9668, 0.9668, 0.9668]
...
my_y_ticks = np.arange(96.4, 97.4, 0.2)
...
plt.savefig('CelebA_model_RA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()