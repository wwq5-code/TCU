...
OUL = [0.56000, 0.5699, 0.5799, 0.5799, 0.5899, 0.61]

org_acc = [0.54, 0.54, 0.54, 0.54, 0.54, 0.54]

vbu_acc = [0.9442, 0.9445,  0.9401, 0.9411, 0.9472, 0.9467]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.56, 0.56, 0.56, 0.56, 0.56, 0.56]
...
plt.legend(loc=(0.03, 0.61),fontsize=20)
plt.tight_layout()
#plt.title("MNIST")
...
plt.savefig('CelebA_model_MIA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()