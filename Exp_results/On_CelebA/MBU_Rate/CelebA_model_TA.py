...
OUL = [0.9644, 0.9634, 0.9630, 0.9625, 0.9624, 0.9621]

org_acc = [0.9647, 0.9647, 0.9647, 0.9647, 0.9647, 0.9647]

vbu_acc = [0.9442, 0.9445,  0.9401, 0.9411, 0.9472, 0.9467]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.9616, 0.9616, 0.9616, 0.9616, 0.9616, 0.9616]
...
my_y_ticks = np.arange(95.8, 96.9, 0.2)
...
plt.savefig('CelebA_model_TA__mbu_r.pdf', format='pdf', dpi=200)
plt.show()