...
OUL = [0.6000, 0.5916, 0.6213, 0.6499, 0.6699, 0.6999]

org_acc = [0.545, 0.545, 0.546, 0.545, 0.55, 0.556]

vbu_acc = [0.9442, 0.9445,  0.9401, 0.9411, 0.9472, 0.9467]
# unl_ss_wo = [94.32, 94.53, 94.78, 93.38, 94.04, 97.21]
vbu_ldp_acc = [0.5799, 0.5899, 0.5999, 0.6299, 0.6399, 0.6599]
