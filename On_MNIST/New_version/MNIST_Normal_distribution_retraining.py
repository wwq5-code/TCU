...
unlearning_dataset = TransformedSubset(unlearning_dataset, transform=trans_mnist)
...
multi_view_dataset_for_retrain = MultiViewMNIST(remaining_dataset, args.k, trans_mnist, trans_mnist)
