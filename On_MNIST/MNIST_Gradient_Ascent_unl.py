...
def vib_train(dataset, model, loss_fn, reconstruction_function, args, epoch, train_type):
    ...
    for step, (x, y) in enumerate(dataset):
        ...
        loss = args.beta * KLD_mean + BCE + H_p_q - nuclear_norm #args.beta * KLD_mean + BCE + H_p_q   # + H_p_q - nuclear_norm  + H_p_q + H_p_q + nuclear_norm
...
# args.model = 'z_linear'
args.model = 'Normal'
args.num_epochs = 10   # round 1 already for cluster without mcr
args.dataset = 'MNIST'
